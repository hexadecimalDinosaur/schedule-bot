...
async def on_message(message):
    ...
    if message.content.lower().startswith('$ping'):
        ...
        elif str(message.author.id) not in data[str(message.channel.guild.id)]['users'].keys() or content[1].upper() not in data[str(message.channel.guild.id)]['users'][str(message.author.id)]['courses']:
